...
void gpio_test(void)
{
	gpio_f1c100s_set_dir(&GPIO_PE, 4, GPIO_DIRECTION_OUTPUT);
    gpio_f1c100s_set_dir(&GPIO_PE, 5, GPIO_DIRECTION_OUTPUT);
    gpio_f1c100s_set_value(&GPIO_PE, 4, 0);
    gpio_f1c100s_set_value(&GPIO_PE, 5, 1);
	gpio_f1c100s_set_dir(&GPIO_PA, 0, GPIO_DIRECTION_INPUT);
	gpio_f1c100s_set_pull(&GPIO_PA, 0, GPIO_PULL_UP);
	while(1)
	{
		if(gpio_f1c100s_get_value(&GPIO_PA, 0))
		{
			gpio_f1c100s_set_value(&GPIO_PE, 4, 0);
			gpio_f1c100s_set_value(&GPIO_PE, 5, 1);
		}
		...
		{
			gpio_f1c100s_set_value(&GPIO_PE, 4, 1);
			gpio_f1c100s_set_value(&GPIO_PE, 5, 0);
		}
	}
}
